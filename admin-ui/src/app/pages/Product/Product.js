...
const Product = () => {
  ...
  const fetchAllProducts = async (sortOrder = false, page = 1, limit = 10) => {
    ...
    if (sortBy === "high-to-low" || sortBy === "low-to-high") {
     ...
     }else if(sortBy === 'active' || sortBy==='non-active')
     {
      url=BACKEND_URL + "/product/list/active";
  ...
  const handleBulkAction = async () => {
    ...
    if (bulkaction === "delete") {
      ...
      if (data && data?.success === true) {
        ...
        dispatch(
          showSnackBar({
            msg: `Bulk Update Fail ${data.exception_reason}`,
            type: "error",
          })
        );
      }
                    ...
                    <tr class="btn-reveal-trigger">
                      ...
                      <td class="py-2 align-middle white-space-nowrap">
                        <div class="dropdown">
                          ...
                          <ul
                            class="dropdown-menu"
                            aria-labelledby={`dropdownbtn_${index}`}
                          >
                            <li>
                              <a
                                class="dropdown-item"
